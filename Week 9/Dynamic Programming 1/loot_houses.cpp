...
int maxMoneyLooted(int *arr, int n, int i = 0, int *temp = new int[10001]())
{
    if (i >= n)
    {
        return 0;
    ...
    int include = arr[i] + maxMoneyLooted(arr, n, i + 2, temp);
    int not_include = maxMoneyLooted(arr, n, i + 1, temp);
